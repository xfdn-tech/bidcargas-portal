...
export function DriverShell({ user, children }: DriverShellProps) {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      <div className="hidden lg:flex">
        <DriverSidebar className="fixed inset-y-0 left-0 z-30" />
      </div>
        ...
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between gap-4 border-b border-border bg-card/80 px-4 backdrop-blur-md sm:px-6">
          <div className="flex items-center gap-3">
            ...
            <div className="hidden sm:block">
              ...
              <p className="text-sm font-medium text-foreground">BidCargas</p>
            </div>
          </div>
